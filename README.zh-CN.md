...
# 或: docker pull crpi-mte80ai8o78b1429.cn-shanghai.personal.cr.aliyuncs.com/xiaozexwz/xzxwz:v0.4.34
...
- 通达信TQ客户端网关自 v0.4.34 起**默认关闭**（需本机客户端＋网关）。开启需 `PANWATCH_ENABLE_TQ=1` 并在数据源页手动启用；关闭后行情/K线自动走腾讯/东财降级链。
