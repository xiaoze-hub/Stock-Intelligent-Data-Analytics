...
# or: docker pull crpi-mte80ai8o78b1429.cn-shanghai.personal.cr.aliyuncs.com/xiaozexwz/xzxwz:v0.4.38
...
- 通达信TQ client gateway is **off by default** since v0.4.38 (needs a local client + gateway). Enable with `PANWATCH_ENABLE_TQ=1` plus manual enable on the Data Sources page; quotes/K-lines then fall back to Tencent/Eastmoney automatically.
